...
export default function PaymentCallback() {
  ...
  function returnToWallet() {
    /*
     * Your existing App.tsx uses pathname-based
     * routing, so we do not use React Router here.
     *
     * AppShell can then open the fund-wallet view
     * if it supports the query parameter.
     */
