...
export default function PaymentCallback() {
  ...
  async function verifyPayment() {
    try {
      ...
      if (!paymentReference) {
        setStatus("failed");
        setMessage("We could not find the Flutterwave payment reference. Please contact support if money was deducted.");
        return;
      }

      setReference(paymentReference);
      const result = await verifyWalletFunding(paymentReference);
