  ...
  async function verifyPayment() {
    try {
      ...
      if (!txRef) {
        ...
        setMessage(
          "We could not find the Flutterwave payment reference.",
        );
          ...
          {status === "success" && (
            <div className="text-center">
              ...
              <button
                ...
                className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-500 px-4 py-3 text-sm font-semibold text-slate-950"
              >
          ...
          {status === "failed" && (
            <div className="text-center">
              ...
              <button
                type="button"
                onClick={returnToWallet}
                className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl border border-slate-700 bg-slate-800 px-4 py-3 text-sm font-semibold text-white"
              >
                <ArrowLeft className="h-4 w-4" />
